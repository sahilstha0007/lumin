      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-4">
            <h3 className="text-2xl font-extrabold tracking-tighter text-foreground mb-6">
              LUMIN
            </h3>
            <p className="text-muted text-sm leading-relaxed max-w-xs">
              Shine brighter with every outfit. Precision design and sustainable
              materials for those who illuminate every room they enter.
            </p>
            <div className="flex gap-4 pt-4">
              <a href="#" className="text-muted hover:text-accent transition">
                <Globe size={20} />
              </a>
              <a href="#" className="text-muted hover:text-accent transition">
          ...
          <div>
            ...
            <ul className="space-y-4 text-muted text-sm">
              ...
              <li>
                <Link href="/lookbook" className="hover:text-accent transition">
                  Lookbook
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-muted text-sm">
              ...
              <li>
                <Link href="/track" className="hover:text-accent transition">
                  Track Order
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="h-8 w-12 bg-surface rounded border border-border flex items-center justify-center text-[10px] font-bold text-muted">
              VISA
            </div>
            <div className="h-8 w-12 bg-surface rounded border border-border flex items-center justify-center text-[10px] font-bold text-muted">
              MC
